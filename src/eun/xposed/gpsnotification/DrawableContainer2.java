 ...
 */
public class DrawableContainer2 extends Drawable implements Drawable.Callback {
   ...
   /*
    ...
    public abstract static class DrawableContainerState extends ConstantState {
        final DrawableContainer2 mOwner;
        ...
        DrawableContainerState(DrawableContainerState orig, DrawableContainer2 owner,
                Resources res) {
            mOwner = owner;
